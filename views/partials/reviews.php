<section id="avis-google" style="padding-top: 20px;">
    <script defer async src='https://cdn.trustindex.io/loader.js?e805f0864ffe3677580653f81a4'></script>
    <div style="text-align: center; margin-top: 20px; margin-bottom: 40px;">
        <a href="https://www.google.com/search?sxsrf=ANbL-n4dsJ1JGbQ_pmf-KwHqeqcZBv2FIA:1770215178944&uds=ALYpb_ncDc7jTlmw6Mmq7NjuX5c-6j-X4zt3NMnJFVMiQ55T1Pn4FcwfCgJeSZF9STrP2BnwOWMWYevFY8_d289amRvO0fidJEGnOJcnt_0AAqt4fAuiQc0Rvf3i2rP2TDmgWniQB2wr&q=SANIFLO+SRL+Avis&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOTGg_iYuL18QN6_pJseFewXrNA8vbsIAitvvfbCH_FIG87Bc8bt7u2fkosF5HBJRGV0quqAjskNLPOUxV0onLzqxbqQ_&hl=fr-BE&aic=0"
           target="_blank"
           class="btn-secondary"
           style="display: inline-block; text-decoration: none; padding: 12px 25px; border: 2px solid var(--primary-blue); color: var(--primary-blue); border-radius: 50px; font-weight: 600; transition: all 0.3s;">
...
<style>
    /* Effet au survol pour la cohérence visuelle avec le reste du site */
    .btn-secondary:hover {
